...
- このプロジェクトの最重要の目的は **人間の人格を再現すること** である
- 会話、記憶、感情、時間、自発行動、視覚、通知などの各機能は、この人格再現を支えるために存在する
