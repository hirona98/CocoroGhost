...
- Policy/Service 実装: `cocoro_ghost/vision/desktop_watch.py`, `cocoro_ghost/vision/camera_watch.py`, `cocoro_ghost/reminders/service.py`, `cocoro_ghost/autonomy/policies/`
