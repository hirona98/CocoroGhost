...
6. `docs/04_検索（思い出す）.md`
7. `docs/05_記憶更新（育てる）.md`（WritePlan + 記憶整理）
8. `docs/06_ストレージ（SQLite）.md`
9. `docs/07_API.md`
10. `docs/12_画像付きチャット.md`
11. `docs/13_WebブラウザUI.md`（Web UI 概要 + 実装メモ）
12. `docs/15_長期会話評価計画.md`（5日おき3ヶ月評価の実行計画）
13. `docs/16_長期会話シナリオ台帳.md`（19セッションの台本概要と期待値）
