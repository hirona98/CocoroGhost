...
def autonomy_deliberation_system_prompt(
    *,
    ...
    lines: list[str] = [
        ...
        "- console_delivery は本文の意味判定ではなく、進行中表示のための構造メタデータとして使う。",
        "- on_complete / on_fail は互換監査用。軽い共有は内部優先度に留め、今すぐ自分から話すのは chat のときだけ。",
        ...
        "  },",
        '  "console_delivery": {',
        '    "on_complete": "silent|activity_only|chat",',
        '    "on_fail": "silent|activity_only|chat",',
