...
def autonomy_deliberation_system_prompt(
    *,
    ...
    lines: list[str] = [
        ...
        "- 3) persona/mood/confirmed_preferences/interest_state/runtime_blackboard/persona_deliberation_focus を根拠に、do_action/skip/defer を選ぶ。",
        ...
        "- reason / defer_reason / persona_influence.summary / mood_influence.summary は人格の内的判断として自然に書く。",
