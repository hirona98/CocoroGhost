...
from cocoro_ghost.storage import db_migrations
...
def _create_memory_indexes(engine) -> None:
    ...
    stmts = [
        ...
        "CREATE INDEX IF NOT EXISTS idx_agenda_threads_report_candidate_level ON agenda_threads(report_candidate_level)",
...
def init_memory_db(embedding_preset_id: str, embedding_dimension: int) -> sessionmaker:
    ...
    import cocoro_ghost.storage.memory_models  # noqa: F401
